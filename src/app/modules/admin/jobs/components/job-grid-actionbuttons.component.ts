...
@Component({
    ...
    <mat-icon aria-hidden="false" aria-label="Example home icon" title="Print Job" style="cursor: pointer;font-size: 20px" (click)="_generatePdf(jobId)">print</mat-icon> 
...
export class JobGridActionbuttonsComponent implements ICellRendererAngularComp {
    ...
    _generatePdf(id){
        this.componentParent.generatePdf(id);
    }
}